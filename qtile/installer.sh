...
paru -S --needed redshift nitrogen picom network-manager-applet firefox pcmanfm pavucontrol peek alacritty ttf-roboto rofi exa starship bash-completion maim dunst dmenu light-locker playerctl pamixer
